...
namespace Amqp {
    ...
    {
        protected static Dictionary<string, string> AllStrings { get; set; }

        static ResourceManager()
        {
            AllStrings.Add("AmqpChannelNotFound", "The session channel '{0}' cannot be found.");
            AllStrings.Add("AmqpHandleExceeded", "Cannot allocate more handles. The maximum number of handles is {0}.");
            //TODO..
        }

        public static string GetString(string key, global::System.Globalization.CultureInfo culture = null)
        {
